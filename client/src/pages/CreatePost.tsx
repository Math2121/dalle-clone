    ...
    <>
      <section className="max-w-7xl mx-auto">
        <div>
          ...
          <p className="mt-2 text-[#666e75] text-[16px] max-w-[500px]">Create imaginative and visually stunning images generated by DALL-E AI and share thwm with the community</p>
        ...
        <form action="" className="mt-16 max-w-3xl" onSubmit={handleSubmit}>
          <div className="flex flex-col gap-5">
            ...
            <FormField
              ...
              type="text"
              name="prompt"
              placeholder="A toy with a yellow hat"
              value={form.prompt}
              handleChange={handleChange}
              isSurpriseMe
          ...
          <div className="mt-5 flex gap-5">
            <button className="text-white bg-green-700 font-medium rounded-md text-md text-sm w-full sm:w-auto px-5 py-2 5 text-center" onClick={generateImage} type="button">
